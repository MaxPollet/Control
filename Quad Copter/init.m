...
%Q_noise = diag([1.5e-3, 1.5e-3, 0.005,4e-3, 2e-3, 6e-3, 1.5e-3, 2e-3, 5e-7, 0.008, 0.008, 2e-7]);
Q_noise = diag([1.5e-7, 1.5e-7, 1.5e-7, 6.5e-7, 6.5e-7, 6.5e-7, 6.5e-8, 6.5e-8, 6.5e-8, 2e-7, 2e-7, 2e-7]);
